...
const Login: FunctionComponent<LoginProps> = () => {
    const [phone, setphone] = useState("994777175454");
    ...
    return (
        <>
            <main className=" lg:flex hidden   justify-center h-[100svh] w-full bg-no-repeat bg-center bg-contain" style={{ backgroundImage: "url('/Group.png')" }}>
                <form action="" onSubmit={handlePost} className=" mt-20 py-11 px-[92px] w-[550px] h-[510px] bg-[rgba(242, 242, 242, 0.8)]  border-[2px] border-white rounded-[20px]" style={{
                    backdropFilter: "blur(9px)"
                }}>
                    <h1 className=" text-3xl font-bold">Kabinetə Giriş</h1>
                    <div>
                        <div className=" relative">
                            <input type="tel" name="phone" placeholder="+994" value={phone} onChange={(e) => setphone(e.target.value)}
