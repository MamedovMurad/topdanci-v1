...
const AboutWholeSale: FunctionComponent<AboutWholeSaleProps> = () => {
    return (<div className=" mt-8 md:px px-5">
        <div className="md:px-[95px] md:py-14 py-4 px-7 bg-[#F0F0F0] md:rounded-[20px] rounded">
            ...
            <div className="mt-10">
            <iframe className=" w-full md:h-[598px] h-[188px]" height="598" src="https://www.youtube.com/embed/QGV0lLvAV2E?si=TFCEv6TA1LEk6N7w" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
            </div>
        </div>
    </div>);
}
